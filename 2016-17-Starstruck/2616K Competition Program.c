...
#pragma config(Motor,  port10,          rightrear,     tmotorVex393_HBridge, openLoop)
...
task Drive() {
    while(true) {
        switch(vectordrive) {
        case true:
            FL = (vexRT[Ch3] /* Y */ + vexRT[Ch1] /* X */) + vexRT[Ch4] /* R */;
            /* FL = -(y + x) - r */
            FR = (-vexRT[Ch3]/* Y */ + vexRT[Ch1] /* X */) + vexRT[Ch4] /* R */;
            /* FR = -(-y + x) - r */
            BR = (-vexRT[Ch3] /* Y */ - vexRT[Ch1] /* X */) + vexRT[Ch4] /* R */;
            /* BR = -(y + x) - r */
            BL = (vexRT[Ch3] /* Y */ - vexRT[Ch1] /* X */) + vexRT[Ch4] /* R */;
            /* BL = -(y - x) - r */
